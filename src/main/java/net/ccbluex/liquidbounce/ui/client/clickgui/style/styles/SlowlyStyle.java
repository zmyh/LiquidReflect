...
public class SlowlyStyle extends Style {
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        ...
        RenderUtils.drawBorderedRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.font35.getHeight() + 3, 3F, new Color(42, 57, 79).getRGB(), new Color(42, 57, 79).getRGB());
        GlStateManager.resetColor();
        Fonts.font35.drawString(text, mouseX + 12, mouseY + (Fonts.font35.getHeight() / 2), Color.WHITE.getRGB());
    }
            ...
            if (moduleElement.isShowSettings()) {
                ...
                for (final Value value : moduleValues) {
                    if (value instanceof BoolValue) {
                        ...
                        final String text = value.getName() + "§f: " + (value instanceof BlockValue ? Block.getBlockById(integerValue.get()).getLocalizedName() + " (" + integerValue.get() + ")" : integerValue.get());
                        final float textWidth = Fonts.font35.getWidth(text);
