    ...
    public void drawPanel(final int mouseX, int mouseY, final int wheel) {
        ...
        if (hudDesigner.selectedElement != null) {
                ...
                try {
                    ...
                    if (o instanceof Value) {
                        ...
                        if (value instanceof BoolValue) {
                            ...
                            int stringWidth = Fonts.font35.getWidth(value.getName());
                            ...
                            int stringWidth = Fonts.font35.getWidth(value.getName() + ": §c" + valueNumber);
                            ...
                            int stringWidth = Fonts.font35.getWidth(value.getName() + ": §c" + integerBigDecimal.toString());
                            ...
                            for (final String s : listValue.getValues()) {
                                ...
                                final int stringWidth = (int) Fonts.font35.getWidth("§c> §r" + s);
                    ...
                    } else if (o instanceof CFontRenderer) {
                        final CFontRenderer fontRenderer = (CFontRenderer) o;
                        ...
                        if (!(fontRenderer instanceof CFontRenderer.MCFont)) {
                            ...
                            displayString = "Font: " + liquidFontRenderer.getFont().getName() + " - " +
                                    liquidFontRenderer.getFont().getSize();
                        } else displayString = "Font: Minecraft";
            ...
            for (final Element element : LiquidBounce.instance.hud.getElements()) {
                ...
                int stringWidth = Fonts.font35.getWidth(element.getName());
