...
public class NullStyle extends Style {
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        ...
        RenderUtils.drawRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.font35.getHeight() + 3, ClickGUI.generateColor().getRGB());
        GlStateManager.resetColor();
            ...
            if (moduleElement.isShowSettings()) {
                ...
                for (final Value value : moduleValues) {
                    if (value instanceof BoolValue) {
                        ...
                        String text = value.getName() + "§f: §c" + (value instanceof BlockValue ? Block.getBlockById(integerValue.get()).getLocalizedName() + " (" + integerValue.get() + ")" : integerValue.get());
                        float textWidth = Fonts.font35.getWidth(text);
                        ...
                        if (!(fontRenderer instanceof CFontRenderer.MCFont)) {
                            final CFontRenderer liquidFontRenderer = (CFontRenderer) fontRenderer;
