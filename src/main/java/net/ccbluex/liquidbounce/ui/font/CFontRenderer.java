...
public class CFontRenderer extends CFont {
    ...
    public float drawString(String text, double x, double y, int color) {
        return drawString0(text, x, y, color, false);
    }

    public float drawStringWithShadow(String text, double x, double y, int color) {
        float shadowWidth = drawString0(text, x + .7F, y + .7F, color, true);
        return Math.max(shadowWidth, drawString0(text, x, y, color, false));
    }
    ...
    private float drawString0(String text, double x, double y, int color, boolean shadow) {
