...
import net.ccbluex.liquidbounce.features.module.modules.render.hud.element.EditorPanel;
...
public class GuiHudDesigner extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (final Element element : LiquidBounce.instance.hud.getElements()) {
/*            if(element instanceof Arraylist) {
        ...
        LiquidBounce.instance.hud.handleMouseMove(mouseX, mouseY);

        if (!LiquidBounce.instance.hud.getElements().contains(selectedElement))
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        LiquidBounce.instance.hud.handleMouseClick(mouseX, mouseY, mouseButton);
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state) {
        ...
        LiquidBounce.instance.hud.handleMouseReleased();
    }
        ...
        switch (button.id) {
            case 1:
                if (selectedElement != null)
                    LiquidBounce.instance.hud.removeElement(selectedElement);
                break;
            case 2:
                ...
                break;
            case 3:
                LiquidBounce.instance.hud.addElement(new Text().setText("").setShadow(true).setRainbow(false).setFontRenderer(Fonts.font40).setX(2).setY(2).setScale(1).setFacing(new Facing(Facing.Horizontal.LEFT, Facing.Vertical.UP)));
                break;
            case 4:
                LiquidBounce.instance.hud.addElement(new TabGUI().setFontRenderer(Fonts.font35).setX(2).setY(25).setFacing(new Facing(Facing.Horizontal.LEFT, Facing.Vertical.UP)));
                break;
            case 5:
                //  PDFClient.instance.hud.addElement(new Arraylist().setFontRenderer(Fonts.font40).setX(0).setY(2).setFacing(new Facing(Facing.Horizontal.RIGHT, Facing.Vertical.UP)));
                break;
            case 6:
                ...
                break;
            case 7:
                LiquidBounce.instance.hud.addElement(new Model().setX(40).setY(100).setFacing(new Facing(Facing.Horizontal.LEFT, Facing.Vertical.UP)));
                break;
            case 8:
                LiquidBounce.instance.hud.addElement(new Armor().setX(8).setY(55).setFacing(new Facing(Facing.Horizontal.MIDDLE, Facing.Vertical.DOWN)));
                break;
            case 9:
                LiquidBounce.instance.hud.addElement(new Effects().setFontRenderer(Fonts.font35).setShadow(true).setX(2).setY(10).setFacing(new Facing(Facing.Horizontal.RIGHT, Facing.Vertical.DOWN)));
                break;
            case 10:
                LiquidBounce.instance.hud.addElement(new Notifications().setX(0).setY(40).setFacing(new Facing(Facing.Horizontal.RIGHT, Facing.Vertical.DOWN)));
                break;
            case 11:
                ...
                LiquidBounce.instance.hud.addElement(new Image().setImage(file).setX(2).setY(2).setFacing(new Facing(Facing.Horizontal.LEFT, Facing.Vertical.UP)));
                break;
            case 12:
                selectedElement = null;
                LiquidBounce.instance.hud.clearElements();
                LiquidBounce.instance.hud = new DefaultHUD();
                selectedElement = null;
                break;
        }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        if (Keyboard.KEY_ESCAPE != keyCode)
            LiquidBounce.instance.hud.handleKey(typedChar, keyCode);
        super.keyTyped(typedChar, keyCode);
    }
}
