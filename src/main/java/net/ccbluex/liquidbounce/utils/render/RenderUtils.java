...
public final class RenderUtils extends MinecraftInstance {
    ...
    public static void drawBlockBox(final BlockPos blockPos, final Color color, final boolean outline) {
        final Timer timer = Mapping.timer;

        final double x = blockPos.getX() - Mapping.renderPosX;
        final double y = blockPos.getY() - Mapping.renderPosY;
        final double z = blockPos.getZ() - Mapping.renderPosZ;
...
*/
    ...
    public static void drawPlatform(final double y, final Color color, final double size) {
        final double renderY = y - Mapping.renderPosY;
